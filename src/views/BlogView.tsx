...
import { Search, Clock, Calendar, User, ArrowRight, Filter, BookOpen } from 'lucide-react';
...
export const BlogView: React.FC<BlogViewProps> = ({ onOpenArticle }) => {
  ...
  return (
    <div className="max-w-[1180px] mx-auto space-y-12 pb-20 pt-6">
      ...
      {featured && (
        <div 
          ...
          className="bg-white rounded-2xl border border-[#E6DDCB] shadow-luxury shadow-luxury-hover overflow-hidden cursor-pointer group grid grid-cols-1 lg:grid-cols-12"
        >
          ...
          <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between space-y-6">
            ...
            <div className="pt-6 border-t border-[#E6DDCB] flex items-center justify-between text-xs text-[#8A8A8A]">
              ...
              <span>{featured.readTime} წაკითხვა</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
        {listArticles.map((article) => (
          <div
            ...
            className="bg-white rounded-2xl border border-[#E6DDCB] shadow-luxury shadow-luxury-hover overflow-hidden cursor-pointer group flex flex-col justify-between"
          >
